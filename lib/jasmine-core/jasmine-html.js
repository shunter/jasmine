...
jasmine.HtmlReporterHelpers.addHelpers = function(ctor) {
  ctor.prototype.createDom = jasmine.HtmlReporterHelpers.createDom;
  ctor.prototype.getSpecStatus = jasmine.HtmlReporterHelpers.getSpecStatus;
};
...
jasmine.HtmlReporter.SpecView = function(spec, dom, views) {
  ...
  this.appendSummaryToSuiteDiv = function() {
    ...
    this.appendToSummary(spec, this.summaryEl)
  };
  ...
  this.appendToSummary = function(child, childElement) {
...
//  jasmine.HtmlReporterHelpers.addHelpers(SuiteView);
...
//    };
//
//    this.appendToSummary(suite, this.element);
//  }
};
